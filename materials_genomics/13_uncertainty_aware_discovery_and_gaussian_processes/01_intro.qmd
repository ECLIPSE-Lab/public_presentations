...
---
## This lecture was cancelled — deck kept as optional reference

::: {.callout-important}
The Week-13 session (07.07.2026) did not take place. The indispensable core of this unit — GP surrogates, acquisition functions & Bayesian optimisation, and the active-learning discovery loop — is delivered live in **Unit 14 (§A2)**. The remaining material here (database/convex-hull recap, sparse / multi-fidelity / batch-GP detail, conformal prediction) was **not covered this term**; this deck stays online as optional self-study.
:::
