---
title: 'Materials Genomics<br>Unit 11: Latent Spaces of Materials (supplementary)'
author:
...
::: {.incremental}
- After the **2026-05-13 realignment**, the Week 11 lecture (23.06.2026) merges representation learning *and* latent-space interpretation into a single 90-minute session delivered from [Unit 10](../10_representation_learning_and_feature_discovery/01_intro.html).
...
- A prototype is a recurring local-environment pattern — the very thing the encoder was trained to recognise (MG U7, U10).
...
::: {.notes}
**Connect to U7.** Local atomic environments (U7) are the input that the encoder turns into $z$. Recurring local environments — the very definition of a prototype — produce nearby $z$. Hence prototypes cluster.
