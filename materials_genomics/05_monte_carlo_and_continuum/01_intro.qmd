...
::: {.incremental}
- **Unit 6**: how do we *encode* crystalline structures so an ML model can read them?
- Classical descriptors (Magpie, matminer) as motivation
- **Graph-based representations** as the modern workhorse (CGCNN, MEGNet, ALIGNN)
- Equivariance and message passing: the conceptual leap to MACE, M3GNet, EquiformerV2
- Unit 7 then turns those representations into **universal force fields** that feed straight back into the MD/MC machinery built today
:::
...
- &rarr; Next: [Unit 06 &mdash; Graph-Based Crystal Representations](../06_graph_based_rep/01_intro.html)
