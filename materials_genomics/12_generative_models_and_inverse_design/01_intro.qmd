...
::: {.incremental}
- **Unit 6**: graphs as the structural language of crystals
- **Unit 7**: local atomic environments + universal MLIPs (MACE-MP-0, M3GNet, CHGNet)
...
- Same backbone trick that drives the MLIP revolution in Unit 7
:::
...
::: {.incremental}
- Universal MLIPs (Unit 7) make this stage cheap: 0.1 s/structure on a GPU
...
- Universal MLIPs (Unit 7) are the indispensable scoring layer of the funnel
