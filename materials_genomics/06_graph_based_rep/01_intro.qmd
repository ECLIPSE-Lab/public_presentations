---
title: 'Materials Genomics<br>Unit 6: Graph-Based Crystal Representations'
author:
...
- Build the math toolkit (PBC, RBF, invariance / equivariance, message passing) that **U7, U9, U10** will rely on
...
## 33. Bridge to Unit 7 (local atomic environments)
...
- U7 makes this explicit with **SOAP / ACSF / ACE**, which can be viewed as fixed-feature MP layers
...
- &rarr; Next: [Unit 07 &mdash; Local Atomic Environments & Universal MLIPs](../07_local_atomic_envs/01_intro.html)
