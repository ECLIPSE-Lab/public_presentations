...
- **Unit 6**: graph-based crystal representations — encoding structures for ML
- **Unit 7+**: universal ML force fields (MACE, M3GNet, CHGNet) that plug directly back into the MD machinery we built today
...
- &rarr; Next: [Unit 05 &mdash; Monte Carlo Sampling & Continuum Mechanics](../05_monte_carlo_and_continuum/01_intro.html)
