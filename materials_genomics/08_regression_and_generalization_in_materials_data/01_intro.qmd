...
- The answer is split design, residual analysis, and reporting discipline.
:::
:::
...
**Forward links.** Unit 9 (next week) introduces neural surrogates — SchNet, CGCNN, MEGNet — and the validation discipline from today carries forward unchanged. The uncertainty-aware discovery material — calibrated error bars on regression predictions, built on today's split-design taxonomy — is delivered in the Unit 14 finale (the Week-13 lecture was cancelled and its core folded in there; the Unit 13 deck remains online as optional reference).
...
- Calibrated uncertainty (GP error bars) — Unit 14 finale (folded-in Week-13 core). Conformal prediction was not covered in MG this term — see MFML U7.
...
**Connect to the Unit 14 finale.** Calibrated uncertainty (GP error bars) is the principled way to estimate per-prediction noise — including target noise plus model uncertainty. Mention now; it's covered in Unit 14 (folded-in Week-13 core — conformal prediction itself was not covered in MG this term).
:::
