...
- *MG Unit 7:* a material is now a feature vector — composition-only Magpie, globally-pooled RDF, local descriptors (ACSF, SOAP), pooled to a material-level $\mathbf{x}$.
...
- We have $\mathbf{x}_i$ from Unit 7. We have a target $y_i$. We can already train a regressor.
...
- &larr; Previous: [Unit 07 &mdash; Local Atomic Environments & Universal MLIPs](../07_local_atomic_envs/01_intro.html)
