---
title: Sub-Ångstrom 3D Resolution, <br>Large-Volume Imaging <br>and Automation Advances <br>in Electron Ptychography
author:
...
::: {.columns}
::: {.column width="20%"}
![Weak-phase appoximation e.g. [1]](./images/wpo.png){width="50%"}

![Single-slice approximation e.g. [2]](./images/single_slice.png){width="50%"}
