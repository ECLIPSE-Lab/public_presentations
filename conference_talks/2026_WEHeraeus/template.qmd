...
![Optical elements and setup of a modern electron microscope](images/TEM.png){height=900px}
...
<iframe
  class="marimo-frame"
  src="https://pelzlab.science/marimo/apps/parallax_ptychography_alignment.html?mode=read&embed=true"
  frameBorder="0"
  width="100%"
  height="800px"
  style="border: none; filter: invert(1) hue-rotate(180deg);"
...
:::
::: {.column width="45%"}
![Adapted from @Yuan_2022: 3D atomic packing in an amorphous solid with liquid-like structure.](images/amorph.png){width="100%"}
:::
:::
