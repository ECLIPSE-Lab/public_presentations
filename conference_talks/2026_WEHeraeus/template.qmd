...
::: {.callout-note .fragment}
A real-space shift $\mathbf{s} = \tfrac{1}{2\pi}\nabla_{\mathbf{k}}\chi$ is a reciprocal-space phase ramp $e^{\,i\,\nabla_{\mathbf{k}}\chi(\mathbf{k})\cdot\mathbf{Q}_p}$ — **parallax is the geometric (quadratic) limit of the full ptychographic overlap kernel** (the direct methods, next).
:::
