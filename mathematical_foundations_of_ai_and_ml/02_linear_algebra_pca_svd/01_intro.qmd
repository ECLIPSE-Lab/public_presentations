...
::: {.column width="40%"}
::: {.callout-note title="Geometric Plot"}
[PLACEHOLDER: Vector $\mathbf{v}$ shown in standard basis $(\mathbf{e}_1, \mathbf{e}_2)$ vs. rotated PCA basis $(\mathbf{u}_1, \mathbf{u}_2)$]
:::
:::
:::
...
::: {.column width="40%"}
::: {.callout-note title="Geometric Plot"}
[PLACEHOLDER: Scatter plot of centered data with superimposed error ellipsoid and its axes (eigenvectors)]
:::
:::
:::
