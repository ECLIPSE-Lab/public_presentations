...
::::
:::: {.column width="55%"}
![McInnes et al. (2018), Fig. 4: UMAP (top row) vs t-SNE and other methods on COIL-20, MNIST, Fashion-MNIST, and word-vector datasets. UMAP preserves both local cluster structure and large-scale topology (the COIL-20 object loops remain intact). [@mcinnes2018umap]](images/umap_mnist_coil20_comparison.png){width=100%}
::::
::::
