...
Plot.plot({
  ...
  color: { domain: ["Activation f(z)", "Derivative f'(z)"], range: ["#4e79a7", "#e15759"] },
  marks: [
    ...
    actFunc === "Sigmoid" ? Plot.ruleY([0.25], {stroke: "#e15759", strokeDasharray: "2,2", strokeOpacity: 0.5}) : null,
    actFunc === "Sigmoid" ? Plot.text([[-3.5, 0.3]], {text: () => "Max derivative = 0.25", fill: "#e15759"}) : null,
    Plot.legend({color: {domain: ["Activation f(z)", "Derivative f'(z)"], range: ["#4e79a7", "#e15759"]}})
  ]
})
```
