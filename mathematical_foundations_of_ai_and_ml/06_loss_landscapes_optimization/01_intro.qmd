...
::: {.placeholder}
[INSERT: Plot comparing ADAM and SGD on a materials dataset, e.g., predicting Li-ion diffusion barrier. Show ADAM converging faster but to a less generalizable minimum.]
:::
...
::: {.placeholder}
[INSERT: Schematic diagram of flat vs sharp minima in a 1D DFT-derived energy surface.]
:::
