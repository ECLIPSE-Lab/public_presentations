...
plot_mom = Plot.plot({
  ...
  color: {domain: ["Vanilla GD", "Momentum"], range: ["gray", "red"], legend: true},
  marks: [
    Plot.contour(grid_mom_fixed, {x: "x", y: "y", fill: "z", thresholds: 15, stroke: "white", strokeOpacity: 0.2}),
    Plot.line(traj_comparison, {x: "x", y: "y", stroke: "algo", strokeWidth: 2, z: "algo"}),
    Plot.dot(traj_comparison, {x: "x", y: "y", fill: "algo", r: 3})
  ]
})
```
:::
...
plot_multi = Plot.plot({
  width: 800, height: 400,
  x: {domain: [-4, 4]},
  y: {domain: [-4, 4]},
  color: {domain: ["GD", "Momentum", "RMSProp", "ADAM"], range: ["gray", "red", "blue", "orange"], legend: true},
  marks: [
    Plot.contour(grid_multi, {x: "x", y: "y", fill: "z", thresholds: 20, stroke: "white", strokeOpacity: 0.2}),
    Plot.line(traj_multi, {x: "x", y: "y", stroke: "algo", strokeWidth: 2, z: "algo"}),
    Plot.dot(traj_multi, {x: "x", y: "y", fill: "algo", r: 3})
  ]
})
```
:::
