...
## 25. Data augmentation as regularizer
...
## 31. Validation-driven model selection
...
## 33. Underfit vs overfit diagnostics
...
## 35. Robust optimization preview
...
## 38. Calibration and loss choice
...
## 39. Domain-specific loss design
...
## 40. Materials example: rare defect cost
...
::: {.column width="50%"}
![Placeholder: Confusion matrix with costs showing high penalty for False Negatives](placeholder_rare_defect_cost.png)
:::
:::

## 41. Materials example: smooth property regression
...
::: {.column width="50%"}
![Placeholder: Comparison of MSE vs Huber fit on dataset with outliers](placeholder_huber_robustness.png)
:::
:::

## 42. Materials example: sparse feature model
...
::: {.column width="50%"}
![Placeholder: Feature importance plot showing sparse non-zero coefficients for Lasso](placeholder_lasso_sparsity.png)
:::
:::
...
## 44. Checklist for loss selection
...
## 45. Exercise 1 scaffold: Loss Comparison
...
## 46. Exercise 2 scaffold: Regularization Sweep
...
## 47. Exercise 3 scaffold: Imbalanced Classification
