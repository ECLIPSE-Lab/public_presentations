---
title: 'Mathematical Foundations of AI & ML<br>Unit 3: Regression and Classification as Loss Minimization'
author:
...
- **Punchline:** every loss is an NLL; every regularizer is a prior. See **ML-PC Unit 2 §28** for the full ML↔Bayes table; **Unit 7** for the formal posterior treatment.
:::
...
- &larr; Previous: [Unit 02 &mdash; Linear Algebra Refresher; Covariance, PCA/SVD](../02_linear_algebra_pca_svd/01_intro.html)
- &rarr; Next: [Unit 04 &mdash; Neural Networks — From Neurons to CNNs](../04_neural_networks_backprop/01_intro.html)
...
### Week 3 notebook: Loss Functions & Leakage — TensileTestDataset
- [Open rendered notebook →](https://eclipse-lab.github.io/Ai4MatLectures/notebooks/week3_loss_and_leakage.html)

Fits the 600 °C tensile data under different loss functions and demonstrates three flavours of data leakage on the same dataset. References to Murphy ch. 6 (linear regression), Bishop ch. 3, McElreath ch. 4–9.
:::
