...
::: {.column width="40%"}
![Placeholder: Image segmentation result showing grains and boundaries](images/placeholder_segmentation.png)
:::
:::
...
::: {.column width="40%"}
![Placeholder: Vector quantization illustration (original vs codebook-represented)](images/placeholder_vq.png)
:::
:::
