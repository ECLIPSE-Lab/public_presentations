...
- Gradient flow through a deep net is a *product* of Jacobians; the product structure dictates whether early layers learn at all.
- ReLU + variance-preserving init (Xavier/He) are the two ingredients that keep that product near 1.
