---
title: |
  Mathematical Foundations of AI & ML<br>Unit 4: Neural Network Architectures and Convolutions
...
- Boundary of this lecture: forward architectures only; backprop comes in Unit 5.
...
:::: {.notes}
- Keep history short: MCP -> thresholds, perceptron -> weights/bias, ADALINE -> smooth error.
- Main message: modern networks are compositions of affine maps and nonlinearities.
- Avoid biology analogy beyond vocabulary.
- Example: a layer is a coordinate transform, not a brain cell.
- Transition: inspect one dense layer.
::::
## A dense layer
...
- Unit 5: gradients through these computations.
- Unit 6: optimizers and normalization.
- Unit 7: generalization and regularization.
...
**Reading for next time.** Review the forward pass equations in this unit and Sandfeld ch. 18.3-18.4 for backpropagation. Unit 5 turns these static architectures into trainable models by deriving the chain rule layer by layer.
...
- Remind students to review tensor shapes before Unit 5.
::::
