...
::: {.fragment}
- Learn relationships from observed \\((\mathbf{x},y)\\) pairs.
...
## 41. How MFML links to Materials Genomics
...
## 43. Lecture-essential vs exercise content split
...
## 44. Exercise setup: NumPy linear regression from scratch
...
## 45. Exercise extension: regularization + split stress test
...
## 46. Exam-aligned summary: 10 must-know statements
...
## 47. References + reading assignment for next unit
