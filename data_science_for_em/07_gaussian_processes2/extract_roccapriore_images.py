#!/usr/bin/env python3
"""
PDF Image Extractor for Roccapriore et al. 2022
===============================================

This script extracts all images from the Roccapriore et al. 2022 PDF file
...
def extract_images_with_pdfimages(pdf_path, output_dir):
    ...
    try:
        ...
        cmd = ['pdfimages', '-all', '-p', str(pdf_path), 'roccapriore_image']
        ...
        extracted_files = list(Path(output_dir).glob("roccapriore_image*"))
...
def main():
    """Main function to extract images from Roccapriore PDF."""
    print("PDF Image Extractor for Roccapriore et al. 2022")
    print("=" * 60)
    ...
    # Define paths
    pdf_file = "Roccapriore et al_2021_Physics discovery in nanoplasmonic systems via autonomous experiments in.pdf"
    output_dir = "roccapriore2021_images"
