...
![ePIE alternating-projection error as a function of iteration for three probe step sizes (75%, 62%, 50% overlap). All three converge monotonically. Higher overlap (step=4, 75%) reaches the lowest final error (0.0021, ~48× improvement); lower overlap (step=8, 50%) converges more slowly to a higher floor (0.0091, ~11× improvement), illustrating that ptychographic redundancy drives reconstruction accuracy.](img/epie_convergence.png){width="65%"}
...
<!-- ===== §6. Generative models as learned priors (5 slides) ===== -->
...
<!-- ===== §7. Generative models for EM (5 slides) ===== -->
