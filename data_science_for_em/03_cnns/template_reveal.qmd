...
![From AlexNet to VGG](img/vgg.svg){width="40%"}
...
::: {.column width="40%"}
![Comparing VGG and NiN architectures](img/nin.svg){width="100%"}
:::
:::
...
::: {.column width="40%"}
![DenseNet connections](img/densenet.svg){width="100%"}
:::
:::
...
![U-Net architecture](img/u-net-architecture.png){width="40%"}
