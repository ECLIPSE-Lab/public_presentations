...
- Python notebooks:
  - [Fitting Gaussian Process Models in Python](https://domino.ai/blog/fitting-gaussian-process-models-python)
  - [Gaussian process regression with noisy targets](https://scikit-learn.org/stable/auto_examples/gaussian_process/plot_gpr_noisy_targets.html)
