...
4. **BO vs random on the fixed notebook seed (SEED=42):** UCB BO (3 initial + 8 iterations) achieves best observed value **0.9133** vs random sampling **0.7950** on the same budget — a 14.9% improvement. BO's best x (0.6421) is within 0.008 of the true optimum (0.65); random is 0.082 away. The assert confirms BO > random at equal budget.
