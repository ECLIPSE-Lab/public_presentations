...
::: {.fragment}
![Layers of explainability along the ML pipeline — data, preprocessing, method, and result, each grounded in a shared ontology [@neuer2024machine, Ch. 7].](images/explainability_pipeline.png){width="60%" fig-align="center"}
:::

## 03. Sensitivity Analysis

- **Local Perturbation** [@neuer2024machine, Ch. 7.2]:
  - Input: $x_i$.
  - Disturb: $x_i + \epsilon$.
  - Measure: $\Delta y$.
...
::: {.fragment}
![Local sensitivity: perturb the input by $\pm\epsilon$ around the nominal point and read off the response $\Delta y$.](images/sensitivity_local.png){width="45%" fig-align="center"}
:::
...
- **Prediction vs. Detection**: AI must move earlier in the chain to allow for intervention [@neuer2024machine, Ch. 7.3.3].

::: {.fragment}
![The anomaly surfaces at the cooling step, but its cause may sit upstream — causal reasoning walks the chain backwards.](images/causal_chain.png){width="70%" fig-align="center"}
:::
...
::: {.fragment}
![Semantic tools ordered by complexity and comprehensiveness — from a flat vocabulary up to a full ontology [@neuer2024machine, Ch. 7].](images/semantic_tools.png){width="75%" fig-align="center"}
:::

::: {.fragment}
![A taxonomy is the first semantic tool with structure: an "is-a" hierarchy, here for the animal kingdom [@neuer2024machine, Ch. 7].](images/taxonomy_bio.png){width="45%" fig-align="center"}
:::
...
- **Neuer (2024)** — Ch. 7 (Explainability and Semantics) [@neuer2024machine].
- **Sandfeld (2024)** — Ch. 1 (Materials Data Science) [@sandfeld_materials_data_science].
- **McClarren (2021)** — Ch. 10 (Future Directions) [@mcclarren2021machine].
