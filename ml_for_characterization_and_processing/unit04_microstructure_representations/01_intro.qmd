...
**Deployment note.** Model compression, quantisation, and deployment hardware are not treated in depth in this course (the planned automation unit was cut in the May realignment). Today's takeaway: in 2026, CNNs are fast enough for in-line process control. That was unthinkable in 2018.
:::
...
- &larr; Previous: [Unit 03 &mdash; Data quality, labels, and leakage](../unit03_data_quality/01_intro.html)
- &rarr; Next: [Unit 05 &mdash; Unsupervised methods for materials — clustering & autoencoders](../unit05_unsupervised_learning/01_intro.html)
