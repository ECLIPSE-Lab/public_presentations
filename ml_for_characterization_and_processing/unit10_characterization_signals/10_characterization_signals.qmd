...
**Forward link.** The MAE encoder reappears in Unit 11 (Automation) as the on-the-fly feature extractor that an active-learning loop queries to decide which spectrum to label next.
:::
...
- &rarr; Next: [Unit 10b &mdash; Transformers for materials (ViT, Flash Attention, Mamba)](../unit10_transformers_for_materials/transformers_for_materials.html)
