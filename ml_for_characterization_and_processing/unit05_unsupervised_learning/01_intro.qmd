...
**Forward link.** Unit 12 (uncertainty/GP) will revisit this picture: each patch prediction should come with a calibrated uncertainty, and the uncertainty map is as important as the mean map. Today we show only the mean.
:::
