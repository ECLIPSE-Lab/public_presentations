---
title: 'Machine Learning in Materials Processing & Characterization<br>Supplementary: Probabilistic Sequence Modelling for Materials Processes'
author:
...
## 02. Supplementary status — read for context

::: {.callout-warning}
**This deck is supplementary self-study, not a delivered lecture.**

ML-PC Week 7 (26.05.2026) is cancelled — public holiday. The SS26 schedule shifts down by one and the originally-planned Time-Series unit (this deck) was demoted to optional reading. Everything that follows still works as a standalone introduction to probabilistic sequence models for materials processes; it is just no longer the W7 lecture.
:::
...
::: {.notes}
**Curriculum-week note (supplementary banner).** With W7 cancelled, this deck is not delivered as a lecture. Forward references to "next week" or "last week" in the rest of the body are historical and should be read as cross-references to neighbouring delivered units.
...
This deck is supplementary self-study (W7 cancelled — public holiday); it is not part of the delivered SS26 schedule.
