...
## 02. Week 8 lecture (02.06.2026) — how to use this deck

<!-- ::: {.callout-note}
**This is the Week 8 lecture (02.06.2026), delivered in class.**

Week 7 (25–26.05.2026) was cancelled for the Pfingsten public holiday, so time-series moved into the Week 8 slot. The Tuesday 02.06.2026 lecture runs in class as scheduled. The Thursday 04.06.2026 exercise is self-study (Fronleichnam — public holiday), with a solution released afterwards.
::: -->
...
- Heteroscedastic regression, conformal prediction → **Unit 12** (Uncertainty & GPs).
- Long-context sequence models (Mamba, transformers) → **Unit 10** (Transformers for materials).
:::
:::
:::

::: {.notes}
**Curriculum-week note.** This is the Week 8 lecture (02.06.2026), delivered in class after Week 7 was cancelled for the Pfingsten holiday; the Thursday 04.06 exercise is self-study (Fronleichnam). Forward references to "next week" or "last week" should be read as cross-references to neighbouring units (next: Unit 8 — Inverse problems).
...
![Standard RNN: the repeating module contains a single $\tanh$ layer. Image: [colah's blog](https://colah.github.io/posts/2015-08-Understanding-LSTMs/).](images/colah_LSTM3-SimpleRNN.png){fig-align="center" width="55%"}
...
![Unrolled RNN — a loop becomes a chain of identical layers. Image: [colah's blog](https://colah.github.io/posts/2015-08-Understanding-LSTMs/).](images/colah_RNN-unrolled.png){fig-align="center" width="70%"}
...
![The cell state $C_t$ flows along the top of the cell like a conveyor belt, modified only by gated additive updates. Image: [colah's blog](https://colah.github.io/posts/2015-08-Understanding-LSTMs/).](images/colah_LSTM3-C-line.png){fig-align="center" width="55%"}
...
::: {.columns}
::: {.column width="35%"}
![Notation: yellow boxes = learned layers, pink circles = pointwise ops, lines carry vectors, merges concat, forks copy.](images/colah_LSTM2-notation.png){fig-align="center" width="100%"}
:::
::: {.column width="65%"}
![The full LSTM repeating module: forget gate, input gate, candidate state, output gate. Images: [colah's blog](https://colah.github.io/posts/2015-08-Understanding-LSTMs/).](images/colah_LSTM3-chain.png){fig-align="center" width="100%"}
:::
:::
...
![Cell-state update $C_t = f_t \odot C_{t-1} + i_t \odot \tilde C_t$ — additive, with $\partial C_t / \partial C_{t-1} = f_t \approx 1$ when the forget gate is on. Image: [colah's blog](https://colah.github.io/posts/2015-08-Understanding-LSTMs/).](images/colah_LSTM3-focus-C.png){fig-align="center" width="55%"}
...
![GRU: update gate $z_t$ merges forget+input, reset gate $r_t$ modulates the candidate; single state $h_t$. Image: [colah's blog](https://colah.github.io/posts/2015-08-Understanding-LSTMs/).](images/colah_LSTM3-var-GRU.png){fig-align="center" width="55%"}
...
**Forward link.** W10 (Transformers) covers attention. Architecture is the dial; the probabilistic head story (§4) is orthogonal and applies to any backbone — LSTM, Mamba, or Transformer.
:::
...
**Forward link.** Today's lecture provides the per-step machinery for sequence prediction; a closed-loop control / automation layer on top is left as an outlook (not a dedicated SS26 unit).
:::
...
Week 8 lecture (02.06.2026), delivered in class after the Week-7 Pfingsten cancellation; the Thursday 04.06 exercise is self-study (Fronleichnam).
