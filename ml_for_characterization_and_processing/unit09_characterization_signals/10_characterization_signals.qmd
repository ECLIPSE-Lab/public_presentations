...
**Forward link.** Outcomes 2 and 4 are the spine of the exercise; outcome 5 forward-links to Unit 10 (automation / self-driving microscopes).
...
**Cross-reference.** SSL family derived MFML u09 (masking / contrastive / JEPA). Today = the MAE branch on spectra. Forward link: the frozen encoder reappears in Unit 10 as the active-learning feature extractor.
...
**Cross-reference.** Method: ML-PC u05 §E. Residual logic: 20. Streaming version: 26. Active-learning closure: Unit 10.
...
**Pre-empt the question.** "Just slide 25 in a loop?" — No: slide 25's nominal set is fixed; here it moves, the threshold must adapt, and the cost of a query (dose) is itself the thing being optimised. That non-stationarity + budgeted-resource framing is the new content and the forward link to Unit 10 (self-driving microscope).

**Cross-reference.** Anomaly method: ML-PC u05 §E. Poisson: ML-PC u02. Beam damage: 23. Adaptive acquisition closure: Unit 10.
...
::: {.callout-important .fragment}
**The methods live in MFML u02/u05/u09 and ML-PC u02/u05. This unit was about what the signal physics demands.** Next: Unit 9b — Transformers for materials.
:::
...
**Forward link.** Unit 9b (transformers) supplies the backbone behind slide 19's foundation models; Unit 10 (automation) closes the operando/anomaly loop into active learning.
