...
::: {.fragment}
| Concept from Unit 7 | Extended in | Topic |
|:--|:--|:--|
| Bias-Variance Tradeoff | Unit 8 | Ensemble Methods & Boosting |
| Cross-Validation | Unit 9 | Bayesian Model Selection |
| Regularization | Units 11-13 | Physics-Informed Neural Networks |
| Process Windows | Unit 10 | Uncertainty Quantification |
| SHAP & Sensitivity | Unit 13 | Explainable AI (XAI) |
:::
