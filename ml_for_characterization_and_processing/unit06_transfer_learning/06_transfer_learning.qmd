...
:::
::: {.column width="52%"}
![Synthetic-trained U-Net segmenting real experimental HRTEM Au nanoparticles. Top row: experimental images; lower rows: model predictions from weak → strong curation (purple = particle, pink = boundary). Rakowski et al., *npj Comput. Mater.* 2024.](images/construction_zone_segmentation.png){fig-align="center" width="100%"}
:::
:::
