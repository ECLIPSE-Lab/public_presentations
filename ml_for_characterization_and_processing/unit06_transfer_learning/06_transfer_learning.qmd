...
::: {.fragment}
![](images/diagram_0.png){fig-align="center"}
:::
...
::: {.fragment}
![](images/rotation_aug.png){width=600px}
:::
...
::: {.fragment}
![](images/diagram_1.png){fig-align="center"}
:::
...
::: {.fragment}
![](images/diagram_2.png){fig-align="center"}
:::
...
::: {.fragment}
![](images/tem_results.png){width=60%}
:::
...
:::
::: {.column width="50%"}
![Construction Zone pipeline: random atomic structures → multislice HRTEM simulation → imaging-condition post-processing → metadata-rich training database with exact masks. Rakowski et al., *npj Comput. Mater.* 2024 (arXiv:2309.06122).](images/construction_zone_pipeline.png){fig-align="center" width="100%"}
:::
:::
...
:::
::: {.column width="52%"}
![Synthetic-trained U-Net segmenting real experimental HRTEM Au nanoparticles. Top row: experimental images; lower rows: model predictions from weak → strong curation (purple = particle, pink = boundary). Rakowski et al., *npj Comput. Mater.* 2024.](images/construction_zone_segmentation.png){fig-align="center" width="75%" background="white"}
:::
:::
...
::: {.fragment}
![](images/voronoi_synthetic.png){width=50%}
:::
...
::: {.fragment}
![](images/sem_results.png){width=50%}
:::
...
::: {.fragment}
![](images/diagram_3.png){fig-align="center"}
:::
...
**Forward link.** This is the same uncertainty machinery as ML-PC Unit 12 (uncertainty quantification / GPs) and the conformal slides; tell students the "how do I know the model is uncertain *honestly*" question is exactly Unit 12's subject. Also recall slide 40 — adaptive synthetic generation was active learning with the generator as the actuator.
...
- &rarr; Next: [Unit 07 &mdash; Time-series and process monitoring (W7 self-study lecture)](../unit07_time_series/01_intro.html)
