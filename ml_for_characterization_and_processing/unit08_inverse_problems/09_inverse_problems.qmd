...
::: {.fragment}
Recall (preview of Unit 11 — PINNs): A **Physics-Informed Neural Network** represents the solution $u(x, t)$ as a neural network and trains it by minimizing:
...
::: notes
- This is a preview of Unit 11, so calibrate depth to your audience — give enough that the inverse trick lands, but do not teach the full PINN machinery yet.
...
- &larr; Previous: [Unit 07 &mdash; Time-series and process monitoring (W7 self-study lecture)](../unit07_time_series/01_intro.html)
